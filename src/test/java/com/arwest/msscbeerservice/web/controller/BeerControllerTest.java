...
import com.arwest.msscbeerservice.web.model.BeerStyleEnum;
...
@AutoConfigureRestDocs(uriScheme = "https", uriHost = "arwestdeveloper", uriPort = 80)
@WebMvcTest(BeerController.class)
@ComponentScan(basePackages = "com.arwest.msscbeerservice.web.mappers")
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                ), requestParameters(parameterWithName("iscold").description("Beer Cold Queryparam")
                        ),
                        responseFields(
